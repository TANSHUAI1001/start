...
public class MenuConstant {
    ...
    public static final String SYSTEM_MENU_FUND = "/fund";
    ...
    public static final String SYSTEM_MENU_MANAGEMENT_ROLE = "/management/role";
    public static final String SYSTEM_MENU_MANAGEMENT_PERMISSION = "/management/permission";
